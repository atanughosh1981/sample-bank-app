...
import com.mck.bank.account.config.audit.AuditEventConverter;
import com.mck.bank.account.domain.PersistentAuditEvent;
...
import static com.mck.bank.account.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
